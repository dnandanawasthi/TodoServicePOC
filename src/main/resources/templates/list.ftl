	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.user.content" id="content" class="form-control input-sm" placeholder="Enter your content." required ng-minlength="3""/>
	                        </div>
	                    </div>
	                </div>
			...
			<div class="table-responsive">
		        <table class="table table-hover">
		            ...
		            <tr ng-repeat="u in ctrl.getAllUsers()">
		                ...
		                <td>{{u.name}}</td>
		                <td>{{u.content}}</td>
		                <td>{{u.lastUpdatedAt|date:'short'}}</td>
                        <td>
                        <ul ng-repeat="u1 in u.todos">
                            <li class="header">{{u1.description}}</li>
                            </ul>
                        </td>
